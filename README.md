...
tinyShield 유저스크립트와 NamuLink 유저스크립트는 더 이상 List-KR에서 관리하지 않습니다.

나무위키 광고차단은 [namuwiki-powerlink-blocker](https://github.com/List-KR/namuwiki-powerlink-blocker)를 참고해주세요.
