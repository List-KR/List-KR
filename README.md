...
Therefore, List-KR cannot be added on AdBlock Plus because AdBlock Plus and Unicorn Pro adblocker do not support advanced syntax (e.g. `!#include`, `#%#//scriptlet()`, `##+js` and `$redirect`).
